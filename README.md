...
Do not commit the Supabase database password, raw refresh tokens, or a complete connection string to the repository.
...
1. Redis rate limiting and hot ranking
2. Outbox events
3. WebSocket/SSE fan-out where realtime delivery is justified
4. Metrics dashboards and load tests
