            ...
            <div className={styles.menuPanel}>
              ...
              <div className={styles.menuActions} aria-label="Connected login providers">
                {linkedProviders.has('GOOGLE')
                  ...
                  : googleEnabled && <button type="button" disabled={linkingProvider !== null} onClick={() => onLinkProvider('google')}>{linkingProvider === 'google' ? 'CONNECTING GOOGLE...' : 'LINK GOOGLE'}</button>}
                {linkedProviders.has('GITHUB')
                  ? <span>GITHUB: LINKED</span>
                  : githubEnabled && <button type="button" disabled={linkingProvider !== null} onClick={() => onLinkProvider('github')}>{linkingProvider === 'github' ? 'CONNECTING GITHUB...' : 'LINK GITHUB'}</button>}
